...
class MyOrderAdapter(var onItemClickLinter: OnItemClickLinter) :RecyclerView.Adapter<MyOrderAdapter.MyOrderViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyOrderViewHolder, position: Int) {
      ...
      var orderItem = orders[position]
       holder.view.orderDate.text = orderItem.createdAt
